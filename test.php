...
if (isset($_POST['sreg'])) {
  ...
  $sreg1 = mysqli_query($conn, "INSERT INTO sregister(firstname, lastname, gender, denomination, Region, Rgroup, District, school, phnumber) VALUES('$firstname', '$lastname', '$gender', '$denomination', '$Region', '$Rgroup', '$District', '$school', '$phnumber' )");
  // var_dump($sreg1);
